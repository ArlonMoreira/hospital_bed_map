            ...
            <div className={`${styles.hospitals_container}`}>
                ...
                </div>
                {
                    hospitals && hospitals.map((hospital, i)=>(
                        <div key={hospital.id} className={`card border-0 shadow ${styles.item} ${styles.hospital}`}>
                    ...
                    <div className={`modal-content ${styles.register_hospital}`}>
                        ...
                        <form className={`${styles.register_form}`} onSubmit={handleSubmit}>
                            ...
                            <div className={`modal-footer border-0 ${styles.modal_footer_bg} px-4`}>
                                ...
                                <input ref={buttonCloseModal} className={`${styles.cancel}`} type='cancel' defaultValue='Cancelar' data-bs-dismiss="modal" aria-label="Close"/>
                            </div>
                        </form>
                    </div>
                </div>
